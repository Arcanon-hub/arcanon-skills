...
Substring match against entire file content. Acts as a cheap pre-filter — if the file doesn't contain any of these strings, the pattern is skipped entirely. Multiple entries are OR'd.
